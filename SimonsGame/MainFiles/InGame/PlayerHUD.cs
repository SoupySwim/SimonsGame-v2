...
namespace SimonsGame.Utility
{
	public class PlayerHUD
	{
		...
		public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
		{
			...
			Rectangle bottomHUDBounds = new Rectangle((int)(_playerViewportBounds.W / 3), (int)(_playerViewportBounds.Z * .95), (int)(_playerViewportBounds.W / 3), (int)(_playerViewportBounds.Z * 045));
			...
			spriteBatch.DrawString(MainGame.PlainFont, "Health:\r\n" + _player.HealthCurrent, new Vector2(bottomHUDBounds.X + 10, bottomHUDBounds.Y + 5), Color.White);
