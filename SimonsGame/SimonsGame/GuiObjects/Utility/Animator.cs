...
namespace SimonsGame.GuiObjects.Utility
{
	public struct Animator
	{
		...
		/// </summary>
		public Vector2 Origin { get { return new Vector2(Animation.Scale.X * Animation.FrameWidth / 2.0f, Animation.Scale.Y * Animation.FrameHeight / 2.0f); } }
		...
		public void Draw(GameTime gameTime, SpriteBatch spriteBatch, Vector2 position, SpriteEffects spriteEffects, float scale = 1.0f)
		{
			...
			Rectangle destination = new Rectangle((int)position.X, (int)position.Y, (int)(Animation.FrameWidth * Animation.Scale.X), (int)(Animation.FrameHeight * Animation.Scale.Y));
