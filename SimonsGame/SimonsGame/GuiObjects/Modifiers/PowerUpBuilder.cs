...
namespace SimonsGame.GuiObjects
{
	public class PowerUpBuilder
	{
		...
		{
			TickModifier modifier = new TickModifier(1, ModifyType.Add, null, Element.Normal);
		...
		{
			TickModifier modifier = new TickModifier(120, ModifyType.Multiply, null, Element.Normal);
		...
		{
			TickModifier modifier = new TickModifier(300, ModifyType.Multiply, null, Element.Normal);
