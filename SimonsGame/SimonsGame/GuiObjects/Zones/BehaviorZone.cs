...
namespace SimonsGame.GuiObjects.Zones
{
	...
	public class BehaviorZone : GenericZone
	{
		...
		{
			foreach (var character in Level.GetAllCharacterObjects().Where(c => c.Team == Team && c.ZoneIds.Contains(Id) && MainGuiObject.GetIntersectionDepth(c.Bounds, Bounds) != Vector2.Zero))
